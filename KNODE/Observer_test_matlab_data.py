...
number_of_tests = 5 # Number of tests to run
...
pendix_name = '_M_G_NoExt_RK4' # Some models folder have a pendix in the name, e.g. '_M' (inertia uncertainities) or '_G' (allocation matrix uncertainities) or '_MG' (both)
